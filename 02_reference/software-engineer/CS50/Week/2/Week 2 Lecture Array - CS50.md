---
tags: ["0", "Arrays", "Command-Line", "Compiling", "Cryptography", "Debugging", "Exit", "Reading", "String", "Strings", "Welcome", "cs50", "include"]
---
#cs50 
- [[#Welcome!]]
- [[#Reading Levels]]
...
### Welcome!
---
description: React notes and reference about Week 2 Lecture Array - CS50.
...
```
- To compile this code, you can type `clang -hello hello.c -lcs50`.
...
![[Pasted image 20250111143753.png]]
...
![[Pasted image 20250111143827.png]]
 - Similarly, an `int`, which requires 4 bytes, might look as follows:
![[Pasted image 20250111143858.png]]
...
![[Pasted image 20250111143939.png]]
