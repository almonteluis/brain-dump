...
tags:
  ...
  - TEAME
sources:
  - TEAME-267 Brain Brake is not show after spending 30 seconds in the Practice Problem's section.md
...
Per [[BB being open in 2 sessions via different browser|sprint status voice memo]]: confirmed resolved. A duplicate / similar-sounding "30 seconds in the work example" item was reviewed and **cancelled** as a duplicate of this resolved fix.
