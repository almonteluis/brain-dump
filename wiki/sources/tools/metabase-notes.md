---
description: "Metabase modular YT video"
tags: ["marvin", "new-classrooms", "engineering"]
raw_file: "metabase-notes.md"
created: 2026-05-17
---

# Metabase modular YT video

Question to answer:
SSo between Roadmaps and Metabase
Parameter/Filter restrictions in the dashboard based on authenticated user identify.

Metbase embedded modular

### Things we need before we begin
- Node installed and running 
- Docker installed 

ok he shared his screen to be on the Github page. I must find this repo: Metabase embedded Analytics SDK for React Workshop
link: https://github.com/metabase/metabase-embedding-sdk-workshop-sample


## Getting started 
1) clone repo find link 
2) install Docker 

((does a quick check in with audience to see if they made it this for ))

3) npm install metabase link 
4) npm run dev 
5) 



disregard the video I was watching I found quick start to work through 
https://www.metabase.com/docs/latest/embedding/sdk/quickstart
