---
description: "Introducing a new spam policy for \'back button hijacking\'  |  Google Search Central Blog"
tags: ['research']
source: "https://developers.google.com/search/blog/2026/04/back-button-hijacking"
raw_file: "Introducing a new spam policy for "back button hijacking"    Google Search Central Blog.md"
created: 2026-05-17
---

Today, we are expanding our [spam policies](https://developers.google.com/search/docs/essentials/spam-policies) to address a deceptive practice known as "back button hijacking", which will become an explicit violation of the " [malicious practices](https://developers.google.com/search/docs/essentials/spam-policies#malicious-practices) " of spam policies, leading to potential spam actions.
...
We believe that the user experience comes first. Back button hijacking interferes with the browser's functionality, breaks the expected user journey, and results in user frustration. People report feeling manipulated and eventually less willing to visit unfamiliar sites. As we've [stated before](https://developers.google.com/search/blog/2013/07/reminder-about-deceptive-behavior), inserting deceptive or manipulative pages into a user's browser history has always been against our [Google Search Essentials](https://developers.google.com/search/docs/essentials).

We've seen a rise of this type of behavior, which is why we're designating this an explicit violation of our [malicious practices](https://developers.google.com/search/docs/essentials/spam-policies#malicious-practices) policy, which says:
...
If your site has been impacted by a manual action and you have fixed the issue, you can always let us know by submitting a [reconsideration request](https://support.google.com/webmasters/answer/35843) in Search Console. For questions or feedback, feel free to reach out on [social media](https://www.linkedin.com/showcase/googlesearchcentral/) or discuss in our [help community](https://support.google.com/webmasters/threads?thread_filter=\(category:search_console\)).
